...
export type InviteRole = "admin" | "saljare" | "saljare_extern" | "ekonomi" | "arbetsledare" | "hantverkare" | "underentreprenor" | "viewer";
...
export const sendEmployeeInvite = createServerFn({ method: "POST" })
  ...
  .inputValidator((input: { email: string; role: InviteRole; displayName?: string; redirectTo?: string }) => {
    ...
    const roles: InviteRole[] = ["admin", "saljare", "saljare_extern", "ekonomi", "arbetsledare", "hantverkare", "underentreprenor", "viewer"];
