...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "admin.vt6" },
      { name: "description", content: "admin.vt6 för takfirmor" },
      { property: "og:title", content: "admin.vt6" },
      { name: "twitter:title", content: "admin.vt6" },
      { property: "og:description", content: "admin.vt6 för takfirmor" },
      { name: "twitter:description", content: "admin.vt6 för takfirmor" },
